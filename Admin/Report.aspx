                             ...
                             <div class="card-header">
                                 <div class="container">
                                     ...
                                     <div class="form-group col-md-4">
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvFromDate" runat="server" ForeColor="red" Display="Dynamic" ErrorMessage="*" 
                                             SetFocusOnError="true" ControlToValidate="txtFromDate"></asp:RequiredFieldValidator>
                                     ...
                                     <div class="form-group col-md-4">
                                         <label>To Date</label>
                                         <asp:RequiredFieldValidator ID="rfvToDate" runat="server" ForeColor="red" Display="Dynamic" ErrorMessage="*" 
